...
func (_Erc20 *Erc20Caller) BridgeAddress(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Erc20.contract.Call(opts, &out, "bridgeAddress")
...
//
// Solidity: function bridgeAddress() view returns(address)
func (_Erc20 *Erc20Session) BridgeAddress() (common.Address, error) {
	return _Erc20.Contract.BridgeAddress(&_Erc20.CallOpts)
}

// BridgeAddress is a free data retrieval call binding the contract method 0xa3c573eb.
//
// Solidity: function bridgeAddress() view returns(address)
func (_Erc20 *Erc20CallerSession) BridgeAddress() (common.Address, error) {
	return _Erc20.Contract.BridgeAddress(&_Erc20.CallOpts)
}
...
func (_Erc20 *Erc20Caller) Cap(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Erc20.contract.Call(opts, &out, "cap")
...
//
// Solidity: function cap() view returns(uint256)
func (_Erc20 *Erc20Session) Cap() (*big.Int, error) {
	return _Erc20.Contract.Cap(&_Erc20.CallOpts)
}

// Cap is a free data retrieval call binding the contract method 0x355274ea.
//
// Solidity: function cap() view returns(uint256)
func (_Erc20 *Erc20CallerSession) Cap() (*big.Int, error) {
	return _Erc20.Contract.Cap(&_Erc20.CallOpts)
}
...
func (_Erc20 *Erc20Transactor) Burn(opts *bind.TransactOpts, account common.Address, value *big.Int) (*types.Transaction, error) {
	return _Erc20.contract.Transact(opts, "burn", account, value)
}

// Burn is a paid mutator transaction binding the contract method 0x9dc29fac.
//
// Solidity: function burn(address account, uint256 value) returns()
func (_Erc20 *Erc20Session) Burn(account common.Address, value *big.Int) (*types.Transaction, error) {
	return _Erc20.Contract.Burn(&_Erc20.TransactOpts, account, value)
}

// Burn is a paid mutator transaction binding the contract method 0x9dc29fac.
//
// Solidity: function burn(address account, uint256 value) returns()
func (_Erc20 *Erc20TransactorSession) Burn(account common.Address, value *big.Int) (*types.Transaction, error) {
	return _Erc20.Contract.Burn(&_Erc20.TransactOpts, account, value)
}
...
// SetBlackList is a paid mutator transaction binding the contract method 0x68092bd9.
//
// Solidity: function setBlackList(address account, bool state) returns()
func (_Erc20 *Erc20Transactor) SetBlackList(opts *bind.TransactOpts, account common.Address, state bool) (*types.Transaction, error) {
	return _Erc20.contract.Transact(opts, "setBlackList", account, state)
}

// SetBlackList is a paid mutator transaction binding the contract method 0x68092bd9.
//
// Solidity: function setBlackList(address account, bool state) returns()
func (_Erc20 *Erc20Session) SetBlackList(account common.Address, state bool) (*types.Transaction, error) {
	return _Erc20.Contract.SetBlackList(&_Erc20.TransactOpts, account, state)
}

// SetBlackList is a paid mutator transaction binding the contract method 0x68092bd9.
//
// Solidity: function setBlackList(address account, bool state) returns()
func (_Erc20 *Erc20TransactorSession) SetBlackList(account common.Address, state bool) (*types.Transaction, error) {
	return _Erc20.Contract.SetBlackList(&_Erc20.TransactOpts, account, state)
}
...
// Erc20SetBlackListIterator is returned from FilterSetBlackList and is used to iterate over the raw logs and unpacked data for SetBlackList events raised by the Erc20 contract.
type Erc20SetBlackListIterator struct {
	Event *Erc20SetBlackList // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Erc20SetBlackListIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Erc20SetBlackList)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Erc20SetBlackListIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Erc20SetBlackListIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Erc20SetBlackList represents a SetBlackList event raised by the Erc20 contract.
type Erc20SetBlackList struct {
	Account common.Address
	State   bool
	Raw     types.Log // Blockchain specific contextual infos
}

// FilterSetBlackList is a free log retrieval operation binding the contract event 0x1365a36244c5f48793fe8c34e438f543de193bdea38c4f133c166dce6fc12145.
//
// Solidity: event SetBlackList(address account, bool state)
func (_Erc20 *Erc20Filterer) FilterSetBlackList(opts *bind.FilterOpts) (*Erc20SetBlackListIterator, error) {

	logs, sub, err := _Erc20.contract.FilterLogs(opts, "SetBlackList")
	if err != nil {
		return nil, err
	}
	return &Erc20SetBlackListIterator{contract: _Erc20.contract, event: "SetBlackList", logs: logs, sub: sub}, nil
}

// WatchSetBlackList is a free log subscription operation binding the contract event 0x1365a36244c5f48793fe8c34e438f543de193bdea38c4f133c166dce6fc12145.
//
// Solidity: event SetBlackList(address account, bool state)
func (_Erc20 *Erc20Filterer) WatchSetBlackList(opts *bind.WatchOpts, sink chan<- *Erc20SetBlackList) (event.Subscription, error) {

	logs, sub, err := _Erc20.contract.WatchLogs(opts, "SetBlackList")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Erc20SetBlackList)
				if err := _Erc20.contract.UnpackLog(event, "SetBlackList", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseSetBlackList is a log parse operation binding the contract event 0x1365a36244c5f48793fe8c34e438f543de193bdea38c4f133c166dce6fc12145.
//
// Solidity: event SetBlackList(address account, bool state)
func (_Erc20 *Erc20Filterer) ParseSetBlackList(log types.Log) (*Erc20SetBlackList, error) {
	event := new(Erc20SetBlackList)
	if err := _Erc20.contract.UnpackLog(event, "SetBlackList", log); err != nil {
		return nil, err
	}
